/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 43bf8651106cfa85d859279a740c8e45)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTGRES_URL" | "E2B_API_KEY" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
declare module "*.txt" {
	const value: string;
