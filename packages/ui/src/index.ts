...
// Session hooks (backed by durable stream collections + ACP)
...
export { useSessionState, type MarkdownSegment } from "./hooks/use-session-state.js";
...
// Agent templates (from REST endpoint)
