...
export function createMcpServer(sessions: SessionManager): McpServer {
  ...
  mcp.registerTool(
    "terminals__exec",
    {
      ...
      inputSchema: {
        ...
        timeout: z.number().optional().describe("Max seconds to wait for completion (default 30)"),
      },
    },
    ...
    "terminals__input",
    {
      ...
      inputSchema: {
        ...
        keys: z
          ...
          .nullable()
          .optional()
          .describe("Special keys to send after text (enter, tab, escape, ctrl+c, etc.)"),
      },
    },
  ...
  mcp.registerTool(
    "terminals__get",
    {
      ...
      inputSchema: {
        sessionId: z.string().describe("Target terminal session"),
        tail: z.number().nullable().optional().describe("Return only the last N lines"),
        since: z
          .number()
          .nullable()
          .optional()
